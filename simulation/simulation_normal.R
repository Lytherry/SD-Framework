...
for(n in data_length){
  ...
  write.csv(p_value_drm, file = paste0("p_value_drm_normal_", n, ".csv"), row.names = FALSE)
  write.csv(adjusted_p_drm, file = paste0("adjusted_p_value_drm_normal_", n, ".csv"), row.names = FALSE)
  write.csv(p_value_emp, file = paste0("p_value_emp_normal_", n, ".csv"), row.names = FALSE)
  write.csv(adjusted_p_emp, file = paste0("adjusted_p_value_emp_normal_", n, ".csv"), row.names = FALSE)
}
