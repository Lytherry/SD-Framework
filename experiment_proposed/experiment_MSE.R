...
cols_n_rows <- list( # colnames and rownames
  Row = c("SegRNN_96_96_mse","ModernTCN_96_96_mse","iTransformer_96_96_mse","MTST_96_96_mse","DLinear_96_96_mse","NLinear_96_96_mse","MTSMixer_96_96_mse"), 
  Col = c("SegRNN_96_96_mse","ModernTCN_96_96_mse","iTransformer_96_96_mse","MTST_96_96_mse","DLinear_96_96_mse","NLinear_96_96_mse","MTSMixer_96_96_mse")
)
...
write.csv(gamma_hat, file = "mse_gamma_hat.csv")
write.csv(p_value, file = "mse_p_value.csv")
