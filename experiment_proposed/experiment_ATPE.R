...
cols_n_rows <- list( # colnames and rownames
  Row = c("SegRNN_96_96_ATPE","ModernTCN_96_96_ATPE","iTransformer_96_96_ATPE","MTST_96_96_ATPE","DLinear_96_96_ATPE","NLinear_96_96_ATPE","MTSMixer_96_96_ATPE"), 
  Col = c("SegRNN_96_96_ATPE","ModernTCN_96_96_ATPE","iTransformer_96_96_ATPE","MTST_96_96_ATPE","DLinear_96_96_ATPE","NLinear_96_96_ATPE","MTSMixer_96_96_ATPE")
)
...
write.csv(gamma_hat, file = "ATPE_gamma_hat.csv")
write.csv(p_value, file = "ATPE_p_value.csv")
