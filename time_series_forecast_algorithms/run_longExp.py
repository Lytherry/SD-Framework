...
if __name__ == '__main__':
    ...
    parser.add_argument('--features', type=str, default='M',
                        help='forecasting task, options:[M, S, MS, M_smaller_dataset, MS_smaller_dataset]; M:multivariate predict multivariate, S:univariate predict univariate, MS:multivariate predict univariate; smaller_dataset allows you to train with the last enc_in variables')
    ...
    parser.add_argument('--small_size', nargs='+', type=int, default=[5],
