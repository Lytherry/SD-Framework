...
cols_n_rows <- list(
  Row = c("SegRNN_96_96_ATPE","ModernTCN_96_96_ATPE","iTransformer_96_96_ATPE",
          "MTST_96_96_ATPE","DLinear_96_96_ATPE","NLinear_96_96_ATPE","MTSMixer_96_96_ATPE"), 
  Col = c("SegRNN_96_96_ATPE","ModernTCN_96_96_ATPE","iTransformer_96_96_ATPE",
          "MTST_96_96_ATPE","DLinear_96_96_ATPE","NLinear_96_96_ATPE","MTSMixer_96_96_ATPE")
)
...
### 5. Save results
write.csv(median_diff, file = "ATPE_wilcox_median_diff.csv")
write.csv(p_value_wilcox, file = "ATPE_wilcox_p_value.csv")
